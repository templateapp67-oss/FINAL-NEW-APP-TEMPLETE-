...
## M75 — Owner provisioning trusted membership gate — 2026-09-02 (current PR)
...
- M75 replaces M63's trigger-DDL workaround with the guard's reviewed trusted
...
- Regression coverage reproduces the exact live P0001 before M75, then verifies
