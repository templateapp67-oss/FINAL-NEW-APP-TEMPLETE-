-- ============================================================================
-- M61 — LIVE APPLY (Supabase SQL Editor paste-ready)
...
--          to_regclass('public.website_bookings') is not null as m41_ok,
--          to_regprocedure('public.cancel_customer_booking_for_actor(uuid,uuid)') is not null as m55_ok;
--   तीनों true होने चाहिए. false आया तो पहले M41 और M55 apply करो.
--
...
--   from public.verify_m61_booking_reschedule()
--   order by check_name;
--   सभी 4 rows ok = true होनी चाहिए.
--
-- ROLLBACK: पूरा script एक transaction है — fail हुआ तो कुछ commit नहीं
-- होगा. Migration सिर्फ एक नया RPC जोड़ता है; कोई existing data नहीं बदलता.
-- ============================================================================
