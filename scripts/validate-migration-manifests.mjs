...
assert.ok(existing.files.at(-8).includes('_m55_'));
assert.ok(existing.files.at(-7).includes('_m56_'));
assert.ok(existing.files.at(-6).includes('_m57_'));
assert.ok(existing.files.at(-5).includes('_m58_'));
assert.ok(existing.files.at(-4).includes('_m59_'));
assert.ok(existing.files.at(-3).includes('_m60_'));
assert.ok(existing.files.at(-1).includes('_m62_'));
ok('Design-A M01-M27 and canonical M28-M62 tracks cannot be conflated');
