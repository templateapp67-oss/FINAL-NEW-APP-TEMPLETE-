...
// M55-M70 in timestamp order. M59-M62 came from main; M63/M64 from that
...
// repair). Asserted by position so a re-ordering or a dropped file fails
// loudly.
const tail = existing.files.slice(-16);
const expectedTail = [
...
ok('Design-A M01-M27 and canonical M28-M70 tracks cannot be conflated');
